...
//            $display = 'none';
        ...
        add_settings_field('idehweb_login_message', __('Enter login message', $this->textdomain), array(&$this, 'setting_idehweb_login_message'), 'idehweb-lwp', 'idehweb-lwp', ['label_for' => '', 'class' => 'ilwplabel']);
...
//        $wp_admin_bar -> add_menu(array('parent' => 'melipayamak', 'title' => 'ملی پیامک', 'href' => 'http://melipayamak.com'));
    ...
    function setting_idehweb_login_message()
    {
		...
		<p class="description">' . __('enter login message', $this->textdomain) . '</p>';
...
//                    }
            ...
            if ($options['idehweb_redirect_url'])
                ...
                echo $options['idehweb_login_message'];
        }
        return ob_get_clean();
    }
